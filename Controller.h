...
// Controller for Protools Music Extractor.
// Intercepts all UI commands and delegates or processes as necessary.
...
__published:	// IDE-managed Components
	...
	TPopupMenu *RightClickMenu;
	TMenuItem *CombineMenuItem;
	...
	void __fastcall CombineMenuItemClick(TObject *Sender);
	void __fastcall DeleteMenuItemClick(TObject *Sender);
	void __fastcall RenameMenuItemClick(TObject *Sender);
	void __fastcall RegionTimeListViewDblClick(TObject *Sender);
...
private:
	...
	// Temporary filename for printing.
